...
<div class="container py-2">
	...
	<h1 class="h3 mb-3" style="color:#00b4d8;font-weight:700;letter-spacing:0.01em;">Servicios</h1>
				...
				<form method="post" id="formulario_servicio" autocomplete="off">
					...
					<div class="row g-3">
						<div class="col-md-4">
							...
							<input class="form-control" type="number" id="precio" name="precio" autocomplete="off" step="0.01">
